#
# nodes: 48, max conn: 48, send rate: 0.05, seed: 1
#
#
...
$ns_ attach-agent $node_(46) $udp_(41)
set null_(41) [new Agent/Null]
$ns_ attach-agent $node_(47) $null_(41)
set cbr_(41) [new Application/Traffic/CBR]
$cbr_(41) set packetSize_ 512
$cbr_(41) set interval_ 0.05
